...
public class commentController {
	...
	public ResponseEntity<?> getCommentId(@PathVariable Long id){
		log.info("id맞는 댓글 가져오기");
		return ResponseEntity.ok(commentService.getCommentId(id));
	}
